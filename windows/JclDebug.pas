...
type
  ...
  private
    ...
    FRefCount: Integer;
    function GetItems(Index: TListIndexType): TJclModuleInfo;
  ...
  public
    ...
    property Items[Index: TListIndexType]: TJclModuleInfo read GetItems;
...
type
  ...
  private
    ...
    function GetItems(Index: TListIndexType): TJclDebugInfoSource;
  protected
  ...
  public
    ...
    property Items[Index: TListIndexType]: TJclDebugInfoSource read GetItems;
  end;
...
type
  ...
  private
    ...
    {$ENDIF CPU64}
    function GetItems(Index: TListIndexType): TJclStackInfoItem;
  ...
  public
    ...
    property Items[Index: TListIndexType]: TJclStackInfoItem read GetItems; default;
...
function TJclModuleInfoList.GetItems(Index: TListIndexType): TJclModuleInfo;
begin
...
function TJclDebugInfoList.GetItems(Index: TListIndexType): TJclDebugInfoSource;
begin
...
function TJclStackInfoList.GetItems(Index: TListIndexType): TJclStackInfoItem;
begin
  ForceStackTracing;
...
function TJclExceptFrameList.GetItems(Index: TListIndexType): TJclExceptFrame;
begin
