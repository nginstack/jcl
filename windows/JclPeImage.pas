...
type
  ...
  private
    ...
    function GetItems(Index: TListIndexType): TJclPeImportFuncItem;
  ...
  public
    ...
    property Items[Index: TListIndexType]: TJclPeImportFuncItem read GetItems; default;
  ...
  private
    ...
    function GetItems(Index: TListIndexType): TJclPeImportLibItem;
  ...
  public
    ...
    property Items[Index: TListIndexType]: TJclPeImportLibItem read GetItems; default;
  ...
  private
    ...
    function GetItems(Index: TListIndexType): TJclPeExportFuncItem;
  ...
  public
    ...
    property Items[Index: TListIndexType]: TJclPeExportFuncItem read GetItems; default;
  ...
  private
    ...
    FParentItem: TJclPeResourceItem;
    function GetItems(Index: TListIndexType): TJclPeResourceItem;
  protected
  ...
  public
    ...
    property Items[Index: TListIndexType]: TJclPeResourceItem read GetItems; default;
    property ParentItem: TJclPeResourceItem read FParentItem;
  end;
  ...
  private
    ...
    function GetItems(Index: TListIndexType): TJclPeRelocEntry;
  ...
  public
    ...
    property Items[Index: TListIndexType]: TJclPeRelocEntry read GetItems; default;
  end;

  // Debug section related classes
  TJclPeDebugList = class(TJclPeImageBaseList)
  private
    function GetItems(Index: TListIndexType): TImageDebugDirectory;
    function IsTD32DebugInfo(DebugDir: PImageDebugDirectory): Boolean;
  protected
    procedure CreateList;
  public
    constructor Create(AImage: TJclPeImage);
    property Items[Index: TListIndexType]: TImageDebugDirectory read GetItems; default;
  end;
  ...
  private
    function GetItems(Index: TListIndexType): TJclPeCertificate;
  protected
    procedure CreateList;
  public
    constructor Create(AImage: TJclPeImage);
    property Items[Index: TListIndexType]: TJclPeCertificate read GetItems; default;
  end;
...
type
  ...
  private
    function GetItems(Index: TListIndexType): TJclPeMapImgHookItem;
  ...
  public
    ...
    property Items[Index: TListIndexType]: TJclPeMapImgHookItem read GetItems; default;
...
function TJclPeImportLibItem.GetItems(Index: TListIndexType): TJclPeImportFuncItem;
begin
...
function TJclPeImportList.GetItems(Index: TListIndexType): TJclPeImportLibItem;
begin
...
function TJclPeExportFuncList.GetItems(Index: TListIndexType): TJclPeExportFuncItem;
begin
...
function TJclPeResourceList.GetItems(Index: TListIndexType): TJclPeResourceItem;
begin
...
function TJclPeRelocList.GetItems(Index: TListIndexType): TJclPeRelocEntry;
begin
...
function TJclPeDebugList.GetItems(Index: TListIndexType): TImageDebugDirectory;
begin
...
function TJclPeCertificateList.GetItems(Index: TListIndexType): TJclPeCertificate;
begin
...
function TJclPeMapImgHooks.GetItems(Index: TListIndexType): TJclPeMapImgHookItem;
begin
